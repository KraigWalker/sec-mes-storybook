...
const content = {
	DYB: {
		...
		noInboxMessages: 'Hmm, looks like you haven’t been sent any secure messages. Remember that only messages from the last 3 years are shown here.',
		noSentMessages: 'Hmm, looks like you haven’t sent any secure messages. Remember that only messages from the last 3 years are shown here.',
		noDraftMessages: 'Hmm, looks like you haven’t saved any secure messages. Remember that only messages from the last 3 years are shown here.',
		noArchivedMessages: 'Hmm, looks like you haven’t archived any secure messages. Remember that only messages from the last 3 years are shown here.',
	...
	CB: {
		...
		thatsallTextArchived: 'That’s all of them. Any new messages you archive will show at the top of your archived items. Remember that only messages from the last 3 years are shown here.',
		noInboxMessages: 'You haven’t received any secure messages. Please note that only messages from the last 3 years are displayed here.',
		noSentMessages: 'You haven’t sent any secure messages. Please note that only messages from the last 3 years are displayed here.',
		noDraftMessages: 'You haven’t saved any secure messages. Please note that only messages from the last 3 years are displayed here.',
		noArchivedMessages: 'You haven’t archived any secure messages. Remember that only messages from the last 3 years are shown here.',		
