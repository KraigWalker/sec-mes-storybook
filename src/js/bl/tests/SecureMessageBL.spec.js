    ...
    describe('SecureMessageBL grouping tests', () => {
      ...
      describe('Messages only, no deleting / archiving / unarchiving records', () => {
        ...
        it ('should have 2 inbox messages', () => {
          expect(result.inboxMessages).toEqual(BuildMessageEntities([
            {
              id: 'C12345',
              status: NEW
            },
        ...
        it ('should have 4 archived messages', () => {
          expect(result.archivedMessages).toEqual(BuildMessageEntities([
            {
              id: 'C11111',
              status: ARCHIVED
            },
        ...
        it ('should have 2 sent messages', () => {
          expect(result.sentMessages).toEqual(BuildMessageEntities([
            {
              id: 'C99999',
              status: SENT
            },
        ...
        it ('should have 1 draft message', () => {
          expect(result.draftMessages).toEqual(BuildMessageEntities([
            {
              id: 'C88889',
              status: DRAFT
            }
