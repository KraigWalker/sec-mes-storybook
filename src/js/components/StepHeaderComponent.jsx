...
import SvgIcon from '../components/common/GetIcon.jsx';
...
class StepHeader extends React.Component {
	...
	getSubtext(){
		...
		_.map(this.props.headerSubtext, (item, index) => {
			subText.push(<p className="c-step-header__subtext">{item}</p>);
		});
		return subText;
	}
	render() {
...
StepHeader.propTypes = {
	...
	headerSubtext:PropTypes.object,
	headerTitle:PropTypes.string,
	headerCrumbsMessage:PropTypes.string,
	showheaderCrumbs:PropTypes.bool,
