...
const ErrorModal = props => {
  ...
  return (
    <ConfirmationModal title={content.sorryHeader} onConfirm={onRetry} isOpen={true} onClose={onCloseClicked} dismissButtonText={content.back} confirmButtonText={content.retry}>
