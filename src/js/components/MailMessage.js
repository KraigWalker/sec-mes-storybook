...
const MailMessage = (props) => {
  ...
  return (
    <div>
      <Mail.ToolBar
        label="Back to inbox"
        archiveOnClick={showArchive ? onArchiveClick : null}
        replyOnClick={showReply ? onReplyClick : null}
        deleteOnClick={showDelete ? onDeleteClick : null}
        moveToInboxOnClick={showUnarchive ? onUnarchiveClick : null}
      ...
      <Mail.Body>
        ...
        <ButtonGroup>
          {showArchive ? (
            <Button display="secondary" onClick={onArchiveClick} width="narrow">
              {content.archive}
            </Button>
          ) : null}
          {showDelete ? (
            <Button display="secondary" onClick={onDeleteClick} width="narrow">
              {content.delete}
            </Button>
          ) : null}
          {showUnarchive ? (
          ...
          {showReply ? (
            <Button display="primary" onClick={onReplyClick} width="narrow">
